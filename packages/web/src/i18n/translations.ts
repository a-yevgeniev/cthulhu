...
const ukSkills: Record<string, string> = {
  ...
  appraise: 'Оцінка майна',
  archaeology: 'Археологія',
  artCraft: 'Мистецтво / ремесло',
  charm: 'Шарм',
  climb: 'Лазіння',
  creditRating: 'Достаток',
  cthulhuMythos: 'Міти Ктулху',
  disguise: 'Маскування',
  dodge: 'Ухиляння',
  driveAuto: 'Водіння',
  electricalRepair: 'Ремонт (електрика)',
  electronics: 'Електроніка',
  fastTalk: 'Обман',
  fightingBrawl: 'Бій (рукопашний)',
  firearmsHandgun: 'Стрільба (пістолет)',
  firearmsRifleShotgun: 'Стрільба (гвинтівка / дробовик)',
  firstAid: 'Перша допомога',
  history: 'Історія',
  intimidate: 'Залякування',
  jump: 'Стрибок',
  languageOwn: 'Мова (рідна)',
  languageOther: 'Мова (іноземна)',
  law: 'Правознавство',
  libraryUse: 'Користування бібліотекою',
  listen: 'Слух',
  locksmith: 'Слюсарство',
  mechanicalRepair: 'Ремонт (механіка)',
  medicine: 'Медицина',
  naturalWorld: 'Природознавство',
  navigate: 'Орієнтування на місцевості',
  occult: 'Окультизм',
  operateHeavyMachinery: 'Керування важкою технікою',
  persuade: 'Переконливість',
  pilot: 'Пілотування',
  psychology: 'Психологія',
  psychoanalysis: 'Психоаналіз',
  ride: 'Верхова їзда',
  science: 'Наука',
  sleightOfHand: 'Вправність рук',
  spotHidden: 'Пошук прихованого',
